          ...
          <div className="uv-container-1 grid grid-cols-1 lg:grid-cols-3 gap-[30px]">
            <div className="pannel-bg-1 pb-[128px] relative">
              <div className="flex flex-col items-center px-[35px]">
                ...
                <div className="btn-link-1 w-[260px] h-[48px] text-[16px] absolute bottom-[30px]" onClick={goSpeaking}>
                  <div>Go to Dapp</div>
            ...
            <div className="pannel-bg-1 pb-[128px] relative">
              <div className="flex flex-col items-center px-[35px]">
                ...
                <div className="btn-link-1 w-[260px] h-[48px] text-[16px] absolute bottom-[30px]" onClick={goListening}>
                  <div>Get Licence</div>
                  <img src={ImgArrowRIcon} className="w-[18px] h-[18px] ml-[10px]" />
                </div>
              </div>
            ...
            <div className="w-full mx-auto flex flex-col items-center justify-end relative">
              ...
              <div className="absolute w-full top-0">
                <div className="relative flex flex-col items-center">
                  ...
                  <div className="text-[32px] text-[#EEEEEE] pt-[30px] max-w-[1050px] p-[60px] text-center z-[200]">
